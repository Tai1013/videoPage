    ...
    div.fixed.inset-0.z-20(v-if="isSearch")
        ...
        div.relative.h-12.bg-white.flex
            ...
            form.flex-1.flex.items-center
                input.flex-1.border-b.border-black.text-sm.h-6.outline-none(class="focus:border-b-2" name="search" placeholder="搜尋 YouTube" autocomplete="off" autocorrect="off" type="text")
                button.p-3
