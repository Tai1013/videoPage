<template lang="pug">
header.h-24
    div.fixed.top-0.w-full.flex.justify-between.items-center.border-b.bg-white
        a.p-3(href="/")
    ...
    div.fixed.top-12.w-full.scrollbar-none.whitespace-nowrap.h-12.overflow-x-auto.overflow-y-hidden.border-b.bg-white
